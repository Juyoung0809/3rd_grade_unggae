            ...
            <>
              ...
              {user.role === 'INSTRUCTOR' && (
                <>
                  ...
                  <button onClick={() => navigate('/instructor/revenue')} className={linkCls('/instructor/revenue')}>
                    수익 현황
                  </button>
                </>
              )}
            ...
            <>
              ...
              {user.role === 'INSTRUCTOR' && (
                <>
                  ...
                  <button
                    onClick={() => { navigate('/instructor/revenue'); setMobileMenuOpen(false) }}
                    className={`w-full text-left px-3 py-2.5 rounded-xl text-sm font-medium transition-colors ${isActive('/instructor/revenue') ? 'text-indigo-600 bg-indigo-50' : 'text-slate-700 hover:bg-slate-100'}`}
                  >
                    수익 현황
                  </button>
                </>
